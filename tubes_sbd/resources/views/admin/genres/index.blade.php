            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left steam-table">
                    ...
                    <tbody>
                                ...
                                <td class="p-4 text-center">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <form action="{{ route('admin.genres.destroy', $genre->genre_id) }}" method="POST"
                                              onsubmit="return confirm('Hapus genre {{ addslashes($genre->name) }}? Semua relasi game akan terputus.');">
                                            @csrf @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="p-8 text-center text-gray-500">Belum ada genre.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
